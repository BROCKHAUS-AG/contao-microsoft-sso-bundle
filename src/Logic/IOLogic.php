...
class IOLogic {
    ...
    {
        $array = $this->loadJsonFileAndDecode(__DIR__ . "/../Resources/config/settings/config.json");
        return array($array["oauth"], $array["group"]["id"]);
    }

    public function loadSAMLSettings() : array
    {
        return $this->loadJsonFileAndDecode(__DIR__ . "/../Resources/config/settings/settings.json");
    }
}